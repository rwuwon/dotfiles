if status is-interactive
  ...
  uname -a
  set PATH ~/.local/bin ~/nix/scripts ~/scripts /usr/sbin $PATH
  ...
  alias l 'ls --color=always -alh --group-directories-first'
  alias la 'ls --color=always -alh --group-directories-first'
  alias l. 'ls --color=always -d .*'
